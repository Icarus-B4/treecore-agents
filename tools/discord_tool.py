...
Only included in the treecore-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Hermes-Agent (https://github.com/NousResearch/treecore-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_treecore_home() / "cache" / "discord_capabilities.json"
