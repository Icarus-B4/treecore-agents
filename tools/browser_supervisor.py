...
DIALOG_BRIDGE_HOST = "treecore-dialog-bridge.invalid"
...
(() => {
  if (window.__treecoreDialogBridgeInstalled) return;
  window.__treecoreDialogBridgeInstalled = true;
  const ENDPOINT = "http://treecore-dialog-bridge.invalid/";
