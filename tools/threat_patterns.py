...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'\$HOME/\.treecore/\.env|\~/\.treecore/\.env', "treecore_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.treecore/(config\.yaml|SOUL\.md)', "treecore_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.treecore/.env``).  NOTE: this
