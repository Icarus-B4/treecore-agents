...
`hey_treecore.onnx` / `hey_treecore.tflite` — the on-device "Hey Hermes" hotword
...
- **Label:** the model registers as `hey_treecore` (matches the filename).
