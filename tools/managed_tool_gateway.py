...
def auth_json_path():
    """Return the Hermes auth store path, respecting TREECORE_HOME overrides."""
    return get_treecore_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`treecore tools`, banner/status paint, provider
