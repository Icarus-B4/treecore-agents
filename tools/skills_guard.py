...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.treecore/\.env|\~/\.treecore/\.env',
     "treecore_env_access", "critical", "exfiltration",
    ...
    (r'\.treecore/config\.yaml|\.treecore/SOUL\.md',
     "treecore_config_mod", "critical", "persistence",
