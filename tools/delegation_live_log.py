...
per child under::
    ...
    <treecore_home>/cache/delegation/live/<delegation_id>/task-<n>.log
...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.treecore)."""
    from treecore_constants import get_treecore_dir

    return get_treecore_dir("cache/delegation", "delegation_cache") / "live"
