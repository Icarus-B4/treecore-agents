...
def _profile_user_agent() -> str:
    """Return a ``treecore-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from treecore_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"treecore-cli/{_ver}"
    except Exception:
        return "treecore-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # treecore-cli UA so the catalog endpoint is reachable.
