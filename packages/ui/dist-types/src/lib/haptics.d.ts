 ...
 */
export type HapticIntent = 'selection' | 'success' | 'warning' | 'error' | 'impact-light' | 'impact-medium' | 'impact-heavy';
...
export declare function registerHapticTrigger(next: HapticTrigger | null): void;
/**
 * Fire a haptic pulse. A no-op when no host trigger is registered — never
 * throws, so primitives can call it unconditionally.
 */
export declare function triggerHaptic(intent?: HapticIntent): void;
