import { type ToolIconProps } from '@/components/ui/tool-icon';
 ...
 * for fenced code.
 */
export declare function FileTypeIcon({ language, path, ...props }: FileTypeIconProps): import("react").JSX.Element;
