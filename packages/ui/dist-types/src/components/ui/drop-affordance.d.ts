...
export declare const DROP_SHEET_CLASS = "rounded-2xl border-2 border-dashed";
/** Soft blur for the LIVE sheet only — idle outlines must not fog the app. */
export declare const DROP_SHEET_BLUR_CLASS = "backdrop-blur-[2px] [-webkit-backdrop-filter:blur(2px)]";
