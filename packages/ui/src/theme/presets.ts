...
export const DEFAULT_TYPOGRAPHY: AppThemeTypography = { fontSans: SYSTEM_SANS, fontMono: SYSTEM_MONO }

const ACCENT_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const accentTint = (pct: number) => `color-mix(in srgb, ${ACCENT_BLUE} ${pct}%, #FFFFFF)`
const accentTintTransparent = (pct: number) => `color-mix(in srgb, ${ACCENT_BLUE} ${pct}%, transparent)`
...
export const defaultTheme: AppTheme = {
  name: 'default',
  label: 'Default',
  description: 'Glass neutrals with a blue accent',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    ...
    secondary: accentTint(7),
    secondaryForeground: '#242432',
    accent: accentTint(10),
    accentForeground: '#202030',
    border: accentTintTransparent(22),
    input: accentTintTransparent(30),
    ring: ACCENT_BLUE,
    midground: ACCENT_BLUE,
    composerRing: ACCENT_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: accentTintTransparent(18),
    userBubble: accentTint(6),
    userBubbleBorder: accentTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
...
export const BUILTIN_THEMES: Record<string, AppTheme> = {
