 ...
 *
 * A skin is authored once as YAML in `$TREECORE_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`treecore_cli/skin_engine.py`),
 ...
 *   • CLI     → `treecore_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
