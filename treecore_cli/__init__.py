...
- treecore chat          - Interactive chat (same as ./treecore)
- treecore gateway       - Run gateway in foreground
- treecore gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `treecore setup` on a fresh Pi.
    ...
    treecore_cli/stdio.py::configure_windows_stdio() runs later from the entry
