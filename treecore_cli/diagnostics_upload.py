"""Client for uploading ``treecore debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``treecore debug share``.
...
NAS_BASE = os.environ.get(
    "TREECORE_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "treecore-agent/debug-share"
