...
Entry point: ``treecore whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``treecore_cli/main.py``).
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print()
    print("  Docs: https://treecore-agent.nousresearch.com/docs/user-guide/")
