...
`treecore skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.treecore/config.yaml under:
...
from treecore_cli.config import cfg_get, load_config, save_config
from treecore_cli.colors import Colors, color
from treecore_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `treecore skills`."""
    from treecore_cli.curses_ui import curses_checklist
