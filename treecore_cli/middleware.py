...
OBSERVER_SCHEMA_VERSION = "treecore.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "treecore.middleware.v1"
...
def _invoke_middleware(kind: str, **kwargs: Any) -> List[Any]:
    from treecore_cli.plugins import invoke_middleware

    return invoke_middleware(kind, **middleware_payload(**kwargs))


def _has_middleware(kind: str) -> bool:
    from treecore_cli.plugins import has_middleware
