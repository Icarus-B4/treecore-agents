...
Invoked by ``treecore kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``treecore_cli/kanban_specify.py``: lazy aux
...
def _profile_author() -> str:
    """Mirror of ``treecore_cli.kanban._profile_author``."""
    return (
