...
DEFAULT_API_URL = "https://setup.treecore-agent.nousresearch.com"
...
def generate_username_slug(length: int = 16) -> str:
    ...
    keeping ``treecore_<slug>_bot`` under Telegram's 32-character username limit.
    """
...
def generate_bot_username(profile_name: Optional[str] = None) -> str:
    """Generate a secure suggested bot username like ``treecore_<slug>_bot``.
    ...
    """
    _ = profile_name
    return f"treecore_{generate_username_slug()}_bot"
