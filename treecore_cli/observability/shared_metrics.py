...
from treecore_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "treecore.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_treecore_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "treecore_version": row["treecore_version"],
    ...
    def _create_counter_aggregates_table(connection: sqlite3.Connection) -> None:
        connection.execute(
            ...
            CREATE TABLE IF NOT EXISTS counter_aggregates (
                ...
                treecore_version TEXT NOT NULL,
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "treecore_version": period_row["treecore_version"],
