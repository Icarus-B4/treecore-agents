"""``treecore cron`` subcommand parser.

Extracted verbatim from ``treecore_cli/main.py:main()`` — same arguments, same
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.treecore/scripts/. Default mode: "
    ...
    cron_create.add_argument(
        ...
        help=(
            ...
            "~/.treecore/scripts/ that runs each tick BEFORE the agent. "
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.treecore/scripts/. Pass empty string to clear. "
    ...
    cron_edit.add_argument(
        ...
        dest="monitor_script",
        help=(
            "Set/replace the monitor source script (see `treecore cron create "
