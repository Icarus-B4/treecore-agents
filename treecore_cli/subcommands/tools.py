"""``treecore tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'treecore tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # treecore tools list [--platform cli]
    ...
    # treecore tools disable <name...> [--platform cli]
    ...
    # treecore tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `treecore tools` runs after you pick a provider that\n"
