...
from treecore_cli.proxy.adapters.base import UpstreamAdapter
from treecore_cli.proxy.adapters.nous_portal import NousPortalAdapter
from treecore_cli.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``treecore proxy start --provider <name>`` CLI flag.
