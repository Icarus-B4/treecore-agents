...
Cron jobs are executed automatically by the gateway daemon:
    treecore gateway install    # Install as a user service
    sudo treecore gateway install --system  # Linux servers: boot-time system service
    treecore gateway            # Or run in foreground
