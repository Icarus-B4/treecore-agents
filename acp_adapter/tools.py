"""ACP tool-call helpers for mapping treecore tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map treecore tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a treecore tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    *,
    ...
    """Create a ToolCallStart event for the given treecore tool invocation.
