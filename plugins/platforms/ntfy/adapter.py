    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "treecore-in"              # subscribe topic (incoming)
          publish_topic: "treecore-out"     # optional — defaults to topic
...
_ECHO_TAG = "treecore-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``treecore cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # env-only setups show up in `treecore gateway status` without
