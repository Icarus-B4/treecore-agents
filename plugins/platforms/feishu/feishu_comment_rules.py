...
Config: ~/.treecore/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.treecore/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_treecore_home()`` helper (TREECORE_HOME-aware and
...
RULES_FILE = get_treecore_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_treecore_home() / "feishu_comment_pairing.json"
