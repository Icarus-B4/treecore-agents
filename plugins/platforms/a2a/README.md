...
```bash
treecore gateway setup      # pick A2A, or:
```
...
- Every exchange is logged to `~/.treecore/a2a_audit.jsonl`.
- Conversations persist to `~/.treecore/a2a_conversations/` — they survive context
