...
``_check_spotify_available()`` — when the user has not run ``treecore auth
spotify``, the tools remain registered (so they appear in ``treecore
...
The Spotify auth flow (``treecore auth spotify``), CLI plumbing, and docs
