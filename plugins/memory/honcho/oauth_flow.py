...
``treecore://`` handler. Endpoints are env-overridable with local-dev defaults
...
_DEFAULT_CLIENT_ID = "treecore-agent"
...
def begin_authorization(
    ...
    *,
    ...
    (``treecore-desktop`` / ``treecore-cli``) so the consent side can attribute
...
def start_loopback_flow_background(
    *,
    ...
    # the request, where a context-local TREECORE_HOME override can't reach.
