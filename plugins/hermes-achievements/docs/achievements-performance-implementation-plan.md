...
- Snapshot persisted at `~/.treecore/plugins/treecore-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.treecore/plugins/treecore-achievements/scan_checkpoint.json`.
