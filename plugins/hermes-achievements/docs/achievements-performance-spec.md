...
Owner: treecore-achievements plugin
...
### `GET /api/plugins/treecore-achievements/achievements`
...
### `POST /api/plugins/treecore-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/treecore-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/treecore-achievements/overview`
...
- Persist plugin data under:
  - `~/.treecore/plugins/treecore-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.treecore/plugins/treecore-achievements/scan_checkpoint.json`
...
- `~/.treecore/plugins/treecore-achievements/`
