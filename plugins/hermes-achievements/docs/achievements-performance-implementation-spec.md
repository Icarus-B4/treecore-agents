...
- persisted runtime files:
  - `~/.treecore/plugins/treecore-achievements/state.json` (existing unlock state)
  - `~/.treecore/plugins/treecore-achievements/scan_snapshot.json` (new)
  - `~/.treecore/plugins/treecore-achievements/scan_checkpoint.json` (new)
