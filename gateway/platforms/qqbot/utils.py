...
def _get_treecore_version() -> str:
    """Return the treecore-agent package version, or 'dev' if unavailable."""
    try:
...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; Hermes/<treecore_version>)
    ...
    treecore_version = _get_treecore_version()
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; Hermes/{treecore_version})"
