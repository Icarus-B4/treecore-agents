...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/treecore_cli-typing
# → /tmp/treecore_cli-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/treecore_cli-typing.before.heapsnapshot
# → /tmp/treecore_cli-typing.after.heapsnapshot
```
