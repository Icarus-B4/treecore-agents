...
// treecore_cli/dashboard_auth/cookies.py.
//
...
// Keep this aligned with treecore_cli.profiles.validate_profile_name(). `default`
 ...
 *     `--profile`, so its `TREECORE_HOME` scopes it.
 *
