...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Treecore Agents agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Treecore Agents agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Treecore Agents agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Treecore Agents agent, and all of your config, chats, secrets, and logs',
...
export function UninstallSection() {
  ...
  useEffect(() => {
    let alive = true
    const bridge = window.treecoreDesktop?.uninstall
