import { isGatewayReauthRequired, resolveGatewayWsUrl } from '@treecore/shared'
...
export function useGatewayRequest() {
  ...
  const connectionRef = useRef<Awaited<ReturnType<NonNullable<typeof window.treecoreDesktop>['getConnection']>> | null>(
    null
  )
