...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'Loading Treecore settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Treecore Desktop…'
    },
    errors: {
      backgroundExited: 'Treecore background process exited.',
      backgroundExitedDuringStartup: 'Treecore background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Treecore backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Treecore',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Treecore Desktop.',
    ...
    native: {
      ...
      inputBody: 'Treecore is waiting for your response.',
      turnDoneTitle: 'Treecore finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Treecore defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Treecore is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Treecore asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Treecore was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Treecore was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Treecore follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Treecore can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Treecore is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Treecore, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        '3Core↬Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Treecore configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Treecore.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Treecore backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private Treecore backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Treecore backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Treecore Cloud',
      cloudDesc: 'Sign in once to Treecore Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Treecore Cloud',
      cloudSignIn: 'Sign in to Treecore Cloud',
      cloudSignedIn: 'Signed in to Treecore Cloud',
      cloudNeedsSignIn: 'Sign in to Treecore Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Treecore Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Treecore Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Treecore Cloud',
      cloudSignedOutMessage: 'Cleared the Treecore Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /Treecore .',
      ...
      restartingMessage: 'Treecore Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Treecore ${version}` : ''}`,
      ...
      sshDesc:
        'Treecore is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Treecore path (optional)',
      sshHermesPathDesc: 'Full path to the remote Treecore  binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Treecore found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Treecore runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrPlatform:
        'Unsupported remote platform. Treecore Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Treecore on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Treecore Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Treecore at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via Treecore  curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Treecore builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Treecore to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Treecore to generate pets.',
      backgroundHint: 'You can close this — Treecore will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Treecore desktop' },
    ...
    hermesActiveSessions: (version, count) => `Treecore ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@treecore :example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Treecore environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Treecore will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Treecore Agents backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Treecore Agents. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Treecore Agents...',
    placeholderReconnecting: 'Reconnecting to Treecore Agents Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Treecore Agents a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Treecore Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Treecore Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Treecore Agents…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Treecore Agents…',
    ...
    unsupportedMessage: 'This version of Treecore Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Treecore Agents is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Treecore Agents backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Treecore Agents from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Treecore Agents will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Treecore Agents desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Treecore Agents updater takes over in its own window and reopens Treecore Agents automatically when it’s done. Please don’t reopen Treecore yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Treecore Agents reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Treecore Agents reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Treecore needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Treecore Agents Desktop',
    setupChoiceDesc:
      'Connect this app to a Treecore gateway you already run, or install Treecore locally on this computer.',
    connectExistingTitle: 'Connect to existing Treecore Agent',
    ...
    installLocalTitle: 'Install Treecore Agents locally',
    installLocalDesc: 'Download Treecore Agents, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Treecore Agents Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Treecore Agent',
    remoteSetupDesc: 'Enter your gateway URL. Treecore Agents Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Treecore gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/treecore  ',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Treecore  gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
  ...
  onboarding: {
    ...
    starting: 'Starting Treecore Agents…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Treecore',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Treecore at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser - Treecore connects automatically',
    ...
    authorizeThere: 'Authorize Treecore there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Treecore there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Treecore Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Treecore Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Treecore will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Treecore is restarting...',
      askRestart: 'Ask Treecore to restart the server',
      lookingRestart: taskId => `Treecore is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Treecore is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Treecore finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Treecore could not restart the server.',
      stillWorking:
        'Treecore is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Treecore is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Treecore gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.Treecore /config.yaml). Treecore won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Treecore needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Treecore needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Treecore Desktop to use Save Image.',
    restartToSaveImages: 'Restart Treecore Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `Treecore  gateway` running?'
    }
  },
