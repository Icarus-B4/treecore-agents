...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        '远程主机上未安装 Treecore Agents。请在远程安装或设置 Treecore Agents 路径。',
  ...
  install: {
    ...
    backToSetup: '返回',
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 Treecore Agents',
    finishingTitle: '正在收尾',
    failedDesc:
  ...
  onboarding: {
    headerTitle: '开始设置 Treecore Agents',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.treecore/config.yaml)。Hermes 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
