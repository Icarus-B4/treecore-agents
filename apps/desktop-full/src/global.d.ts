import type { GatewayWsUrlResult } from '@treecore/shared'
  ...
  interface Window {
    treecoreDesktop: {
      ...
      profile: {
        ...
        // backend under the new TREECORE_HOME (reloads the window). Pass null to
      ...
      // Local Desktop runtime-plugin root (<TREECORE_HOME>/desktop-plugins),
