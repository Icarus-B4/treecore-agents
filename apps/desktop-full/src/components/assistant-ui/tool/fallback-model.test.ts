  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://treecore-agents.raw/install/docs' },
    ...
    expect(view.title).toBe('Failed to open treecore-agents.raw/install/docs')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://treecore-agents.raw/install/docs' },
        result: { success: true, url: 'https://treecore-agents.raw/install/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened treecore-agents.raw/install/docs')
  })
})
