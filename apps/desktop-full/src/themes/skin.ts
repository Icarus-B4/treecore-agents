 ...
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$TREECORE_HOME/skins/` (or a
 * built-in) resolved by `treecore_cli/skin_engine.py` and pushed to every surface
...
import type { HermesSkin, SkinColors } from '@treecore/shared/skin'
