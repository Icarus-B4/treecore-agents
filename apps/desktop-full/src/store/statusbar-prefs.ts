...
// for the Treecore Agents fork so the bar is always present (Ctrl+Shift+S still
// toggles it). Hiding it unmounts the bar (its 15s status poll goes with it),
// so the way back is the `view.toggleStatusbar` keybind or the ⌘K row.
