...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @treecore/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@treecore/shared'],
              message: 'Plugins import only @treecore/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
