...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Treecore Agents' : 'Setting up Treecore Agents'

  const description = isUpdate
    ? 'Treecore Agents is updating to the latest version — this only takes a moment.'
  ...
  return (
    <div className="treecore-fade-in flex h-full flex-col">
