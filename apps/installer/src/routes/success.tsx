...
/*
 * Success screen. TREECORE AGENTS wordmark stays as the visual anchor
...
export default function Success() {
  ...
  return (
    <div className="treecore-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
