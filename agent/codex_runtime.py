...
# treecore-tools-mcp-server subprocess that has no access to the parent
...
# the display event for those calls; we strip the mcp.treecore-tools.*
...
# not as MCP calls.
_INTERNAL_MCP_SERVER = "treecore-tools"
...
def run_codex_app_server_turn(
    ...
    *,
    ...
    if not hasattr(agent, "_codex_session") or agent._codex_session is None:
        ...
        # in config, the /yolo session toggle, or --yolo / TREECORE_YOLO_MODE —
