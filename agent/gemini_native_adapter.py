        ...
        with httpx.Client(timeout=timeout) as client:
            resp = client.post(
                ...
                headers={
                    ...
                    "X-Goog-Api-Client": f"treecore-agent/{_TREECORE_VERSION}",
                },
            )
...
_STANDARD_KEY_GUIDANCE = (
    ...
    "GOOGLE_API_KEY in ~/.treecore/.env and restart your session. "
...
class GeminiNativeClient:
        ...
        **_: Any,
        ...
        if not (api_key or "").strip():
            raise RuntimeError(
                ...
                "Set GOOGLE_API_KEY or GEMINI_API_KEY in your environment / ~/.treecore/.env "
                "(get one at https://aistudio.google.com/app/apikey), or run `treecore setup` "
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": f"treecore-agent/{_TREECORE_VERSION} (gemini-native)",
            "X-Goog-Api-Client": f"treecore-agent/{_TREECORE_VERSION}",
        }
