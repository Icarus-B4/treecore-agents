...
SESSION_SCOPE = "treecore.session"
TURN_SCOPE = "treecore.turn"
LOGICAL_LLM_SCOPE = "treecore.logical_llm_call"
RUNTIME_SCHEMA_KEY = "treecore.relay.schema_version"
RUNTIME_SCHEMA_VERSION = "treecore.relay.runtime.v1"
RUNTIME_INSTANCE_KEY = "treecore.relay.runtime_instance"
...
_CURRENT_TURN: contextvars.ContextVar[RelayTurnContext | None] = contextvars.ContextVar(
    "treecore_relay_turn", default=None
)
        ...
        *,
        ...
        if isinstance(host, RelayRuntime):
            try:
                ...
                metadata = {"treecore.execution_surface": platform or "unknown"}
            ...
            try:
                turn.handle = lease.host.run_in_session(
                    ...
                    metadata={
                        ...
                        "treecore.execution_surface": lease.platform or "unknown",
                    },
                )
            except Exception:
