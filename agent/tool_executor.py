...
def _resolve_concurrent_tool_timeout() -> float | None:
    raw = os.getenv("TREECORE_CONCURRENT_TOOL_TIMEOUT_S", "").strip()
    if not raw:
    ...
    try:
        ...
        logger.warning(
            "invalid TREECORE_CONCURRENT_TOOL_TIMEOUT_S=%r; using %.0fs",
            raw,
...
def _run_agent_tool_execution_middleware(
    ...
    *,
    ...
    from treecore_cli.middleware import (
    ...
    def _treecore_pipeline(relay_args: dict[str, Any]) -> Any:
