...
_TREECORE_TO_CODEX_PERMISSION_PROFILE = {
...
class CodexAppServerSession:
    ...
    def __init__(
        ...
        *,
        ...
        self._permission_profile = (
            permission_profile or _TREECORE_TO_CODEX_PERMISSION_PROFILE.get(
                os.environ.get("TREECORE_TERMINAL_SECURITY_MODE", "auto"),
                "workspace-write",
            )
        )
    ...
    def ensure_started(self) -> str:
        ...
        self._client.initialize(
            client_name="treecore",
            client_title="Hermes Agent",
            client_version=_get_treecore_version(),
        )
    ...
    def _handle_server_request(self, req: dict) -> None:
        ...
        if method == "item/commandExecution/requestApproval":
            ...
            # OAuth, form data). For our own treecore-tools callback we
