...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Hermes also honours TREECORE_CA_BUNDLE (its own convention)
    ...
    """
    for env_var in ("TREECORE_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE"):
...
def _local_probe_disk_cache_path() -> Path:
    ...
    return get_treecore_home() / "cache" / "local_endpoint_probes.json"
...
def _get_model_metadata_cache_path() -> Path:
    ...
    from treecore_constants import get_treecore_home
    return get_treecore_home() / "cache" / "openrouter_model_metadata.json"
...
def _get_context_cache_path() -> Path:
    ...
    from treecore_constants import get_treecore_home
    return get_treecore_home() / "context_length_cache.yaml"
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot"}:
        try:
            from treecore_cli.models import get_copilot_model_context
