...
def openclaw_residue_hint_cli() -> str:
    ...
    Points users at ``treecore claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``treecore claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "`treecore claw migrate`.\n"
        "If you've already migrated and want to archive the old directory, "
        "run `treecore claw cleanup` (renames it to ~/.openclaw.pre-migration — "
