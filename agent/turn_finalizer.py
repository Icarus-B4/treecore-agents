...
decomposition campaign (``~/.treecore/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("TREECORE_KANBAN_TASK")
        if _kanban_task:
            try:
    ...
    result = {
        ...
        # billing audits by callers like `treecore -z --usage-file`.
        "service_tier": (
