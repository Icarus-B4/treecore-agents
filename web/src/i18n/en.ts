...
export const en: Translations = {
  ...
  status: {
    ...
    updateHermesConfirmMessage:
      "This runs treecore update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Treecore?",
    updatingHermes: "Updating Treecore…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Treecore plugins (`treecore plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Treecore doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Treecore Achievements",
      subtitle:
        "Collectible Treecore badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Treecore session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Treecore more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Treecore sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Treecore is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Treecore Agent ☤",
    },
  },
