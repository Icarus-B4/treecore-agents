...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateHermes: "Nuashonraigh Treecore",
    updatingHermes: "Ag nuashonrú Treecore…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Treecore (paireacht le `treecore plugins`).",
  ...
  env: {
    ...
    customHint: "Athróga timpeallachta treallach atá stóráilte i do .env nach n-aithníonn Treecore. Úsáid iad chun athróga timpeallachta a instealladh do scileanna, freastalaithe MCP, nó d'uirlisí féin.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Suaitheantais Treecore inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",
      scan_subtitle:
        "Stair session Treecore á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith Treecore níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann Treecore comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann Treecore an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
