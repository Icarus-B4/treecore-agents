...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateHermes: "Aggiorna Treecore",
    updatingHermes: "Aggiornamento di Treecore…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Treecore (parità con `treecore plugins`).",
  ...
  env: {
    ...
    customHint: "Variabili d'ambiente arbitrarie salvate nel tuo .env che Treecore non riconosce. Usale per iniettare variabili d'ambiente per skill, server MCP o i tuoi strumenti.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Treecore da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Treecore in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Treecore di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Treecore rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Treecore sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
