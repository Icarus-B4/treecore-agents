...
export const ar = defineLocale({
  ...
  status: {
    ...
    stopped: "متوقف",
    updateHermes: "تحديث Treecore",
    updatingHermes: "جاري تحديث Treecore…",
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات Treecore الإضافية (مطابقة `treecore plugins`).",
  ...
  achievements: {
    hero: {
      ...
      title: "إنجازات Treecore",
      subtitle:
        "شارات Treecore قابلة للجمع مكتسبة من سجل الجلسات الفعلي. الإنجازات غير المكتملة المعروفة تُعرض كـ Discovered؛ تبقى الإنجازات السرية مخفية حتى يظهر السلوك المطابق لأول مرة.",
      scan_subtitle:
        "فحص سجل جلسات Treecore. يمكن أن يستغرق الفحص الأول 5–10 ثوانٍ على السجلات الكبيرة.",
    },
    actions: {
      rescan: "إعادة الفحص",
    },
    stats: {
      ...
      latest: "الأحدث",
      latest_hint_empty: "شغِّل Treecore أكثر",
    ...
    guide: {
      ...
      secret_body:
        "تخفى الأسرار محددها الدقيق. بمجرد أن ترى Treecore إشارة ذات صلة، تصبح البطاقة مكتشفة وتعرض متطلباتها.",
      scan_status_header: "حالة الفحص",
      scan_status_body:
        "تُفحص Treecore السجل المحلي مرة واحدة، ثم تظهر البطاقات تلقائيًا. لا يوجد توقف إذا استغرق هذا بضع ثوانٍ.",
    ...
    share: {
      ...
      tweet_text: "فتحت للتو {tier_part}\"{name}\" في Treecore Agent ☤"
    },
  },
