...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateHermes: "Treecore aktualisieren",
    updatingHermes: "Treecore wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Treecore-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `treecore plugins`).",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Treecore nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Treecore-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Treecore-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Treecore mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Treecore ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Treecore scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
