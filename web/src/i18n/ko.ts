...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateHermes: "Treecore 업데이트",
    updatingHermes: "Treecore 업데이트 중…",
  ...
  pluginsPage: {
    ...
    headline:
      "Treecore 플러그인을 검색, 설치, 활성화 및 업데이트합니다 (`treecore plugins` 동등).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "실제 세션 기록에서 획득하는 Treecore 컬렉터블 배지입니다. 알려져 있지만 아직 달성되지 않은 업적은 Discovered로 표시되며, Secret 업적은 일치하는 동작이 처음 나타날 때까지 숨겨집니다.",
      scan_subtitle:
        "Treecore 세션 기록을 스캔하고 있습니다. 기록이 많으면 첫 스캔에 5~10초가 걸릴 수 있습니다.",
    },
    actions: {
      rescan: "다시 스캔",
    },
