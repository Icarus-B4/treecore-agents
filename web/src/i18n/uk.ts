...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateHermes: "Оновити Treecore",
    updatingHermes: "Оновлення Treecore…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Treecore (паритет з `treecore plugins`).",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які Treecore не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Колекційні значки Treecore, отримані з реальної історії сеансів. Відомі, але ще не виконані досягнення показані як Виявлені; Секретні досягнення залишаються прихованими, доки не з'явиться перший відповідний сигнал.",
      scan_subtitle:
        "Сканування історії сеансів Treecore. Перше сканування на великих історіях може тривати 5–10 секунд.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Останнє",
      latest_hint_empty: "запускайте Treecore частіше",
      none_yet: "Поки немає",
    },
    state: {
      unlocked: "Розблоковано",
    ...
    guide: {
      ...
      secret_body:
        "Секрети приховують свій точний тригер. Щойно Treecore побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",
      scan_status_header: "Стан сканування",
      scan_status_body:
        "Treecore одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
